...
(function($) {
    $.fn.amazingaudioplayer = function(options) {
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            if (this.options.showbackgroundimage) this.container.css({
                "background-image": 'url("' + this.options.skinsfolder + this.options.backgroundimage + '")'
            });
            if (this.options.showimage) {
                this.$image = $("<div class='ap-image'></div>");
                ...
                this.container.bind("amazingaudioplayer.updateinfo", function(event, data) {
                    if (data.image.length > 0) instance.$image.html("<div class='ap-image-space' style='display:inline-block;vertical-align:middle;height:100%;'></div><img src='" + data.image + "' style='width:100%;max-width:100%;vertical-align:middle;' />");
                    else instance.$image.empty()
                });
                this.container.append("<div class='ap-image-clear'></div>")
            }
            if (this.options.showtitle ||
                this.options.showinfo) {
                this.$text = $("<div class='ap-text'></div>");
                this.$text.appendTo(this.container);
                if (this.options.showtitle) {
                    this.$title = $("<div class='ap-title'></div>");
                    ...
                    this.$text.append("<div class='ap-title-clear'></div>")
                }
                if (this.options.showinfo) {
                    this.$info = $("<div class='ap-info'></div>");
                    ...
                    this.$text.append("<div class='ap-info-clear'></div>")
                }
                this.container.append("<div class='ap-text-clear'></div>")
            }
            var $bar =
                $("<div class='ap-bar'></div>");
            $bar.appendTo(this.container);
            if (this.options.showbarbackgroundimage) $bar.css({
                "background-image": 'url("' + this.options.skinsfolder + this.options.barbackgroundimage + '")'
            });
            var $playpause = $("<div class='ap-playpause'></div>");
            $playpause.appendTo($bar).css({
                display: "block"
            });
            var $play = $("<div class='ap-play'></div>");
            ...
            var $pause = $("<div class='ap-pause'></div>");
            ...
            if (this.options.showstop) {
                var $stop = $("<div class='ap-stop'></div>");
            ...
            if (this.options.showprevnext) {
                var $prev = $("<div class='ap-prev'></div>");
                ...
                var $next = $("<div class='ap-next'></div>");
            ...
            if (this.options.showtitleinbar) {
                this.$bartitle = $("<div class='ap-bar-title'></div>");
                ...
                this.container.bind("amazingaudioplayer.updateinfo", function(event, data) {
                    ...
                    instance.$bartitletext =
                        $("<span class='ap-bar-title-text'>" + t + "</span>");
            ...
            if (this.options.showvolume && !AmazingAudioPlatforms.isIOS() && !AmazingAudioPlatforms.isAndroid()) {
                this.$volume = $("<div class='ap-volume'></div>");
                this.$volume.appendTo($bar);
                this.$volumeButton = $("<div class='ap-volume-button'></div>");
                ...
                if (this.options.showvolumebar) {
                    this.$volumeBar = $("<div class='ap-volume-bar'></div>");
                    this.$volumeBar.appendTo(this.$volume);
                    this.$volumeBarAdjust = $("<div class='ap-volume-bar-adjust'></div>");
                    this.$volumeBarAdjust.appendTo(this.$volumeBar);
                    this.$volumeBarAdjustActive =
                        $("<div class='ap-volume-bar-adjust-active'></div>");
                ...
                this.container.bind("amazingaudioplayer.setvolume",
            ...
            if (this.options.showtime) {
                var $time = $("<div class='ap-time'></div>");
                $time.appendTo($bar);
                this.container.bind("amazingaudioplayer.playprogress", function(event, data) {
                    ...
                    else t = instance.options.timeformat.replace("%CURRENT%",
            ...
            if (this.options.showprogress) {
                var $progress = $("<div class='ap-progress'></div>");
                var $progressLoaded = $("<div class='ap-progress-loaded'></div>");
                var $progressPlayed = $("<div class='ap-progress-played'></div>");
            ...
            $bar.append("<div class='ap-bar-buttons-clear'></div>");
            this.container.append("<div class='ap-bar-clear'></div>");
            if (this.options.showtracklist) {
                this.$tracklistwrapper = $("<div class='ap-tracklist'></div>");
                this.$tracklistwrapper.appendTo(this.container);
                this.$tracklistwrapper.css({
                    display: "block",
                    height: "auto"
                });
                this.$tracklistcontainer = $("<div class='ap-tracklist-container'></div>");
                ...
                if (this.options.showtracklistbackgroundimage) this.$tracklistcontainer.css({
                    "background-image": 'url("' + this.options.skinsfolder + this.options.tracklistbackgroundimage + '")'
                });
                this.$tracklist = $("<div class='ap-tracks-wrapper'></div>");
                this.$tracklist.appendTo(this.$tracklistcontainer);
                this.$tracks = $("<ul class='ap-tracks'></ul>");
                ...
                this.container.bind("amazingaudioplayer.switched", function(event, data) {
                    if (data.previous >= 0) {
                        instance.trackitems[data.previous].removeClass("ap-track-item-active");
                        instance.trackitems[data.previous].removeClass("ap-track-item-hoverover")
                    }
                    if (data.current >= 0) {
                        instance.trackitems[data.current].addClass("ap-track-item-active");
                        instance.trackitems[data.current].removeClass("ap-track-item-hoverover");
                ...
                for (var i = 0; i < this.amazingPlayer.elemLength; i++) {
                    var $track = $("<li class='ap-track-item'></li>");
                    ...
                    $track.hover(function() {
                        $(this).addClass("ap-track-item-active");
                        if ($(this).data("order") != instance.amazingPlayer.currentItem) $(this).addClass("ap-track-item-hoverover")
                    }, function() {
                        if ($(this).data("order") != instance.amazingPlayer.currentItem) $(this).removeClass("ap-track-item-active");
                        $(this).removeClass("ap-track-item-hoverover")
                    })
                }
                this.$tracklist.css({
                    overflow: "hidden"
                ...
                if (this.options.tracklistitem < this.amazingPlayer.elemLength) {
                    ...
                    this.$tracklistarrowprev = $("<div class='ap-tracklist-arrow-prev'></div>");
                    ...
                    this.$tracklistarrownext = $("<div class='ap-tracklist-arrow-next'></div>");
                ...
                this.container.append("<div class='ap-tracklist-clear'></div>")
            }
        ...
        FlashHTML5Player.prototype = {
            ...
            load: function(audioItem) {
                ...
                if (this.isHtml5) {
                    ...
                    this.flashAudioLoadedSucceed = false;
                    this.playAudioAfterLoadedSucceed = false;
                    if (this.amazingPlayer.options.preloadaudio) this.flashLoadAudio(this.getMp3Src(),
                        false)
                }
            },
            html5LoadAudio: function() {
                ...
                this.html5LoadUpdate = setInterval(function() {
                    if (html5Audio.buffered && html5Audio.buffered.length > 0 && !isNaN(html5Audio.buffered.end(0)) && !isNaN(html5Audio.duration)) {
                        ...
                        instance.amazingPlayer.playProgress(html5Audio.currentTime *
            ...
            setTime: function(pos, duration) {
                if (this.isHtml5)
                    if (!isNaN(this.html5Object.get(0).duration) && isFinite(this.html5Object.get(0).duration) &&
                        this.html5Object.get(0).duration > 0) this.html5Object.get(0).currentTime = this.html5Object.get(0).duration * pos;
        ...
        AmazingAudioPlayer.prototype = {
            ...
            readTags: function() {
                var instance = this;
                $("ul.ap-audios", this.container).find("li").each(function() {
                    var $this = $(this);
                    var audioSource =
                        new Array;
                    $this.find("div.ap-source").each(function() {
                        audioSource.push({
                            src: $(this).data("src"),
            ...
            audioRun: function(index, autoPlay) {
                ...
                if (index == -2) nextItem = this.currentItem <=
                    0 ? this.elemLength - 1 : this.currentItem - 1;
            ...
            onAudioEnded: function() {
                this.container.trigger("amazingaudioplayer.ended",
                    this.currentItem);
        ...
        this.each(function() {
            ...
            if (typeof amazingaudioplayer_options !=
                "undefined" && amazingaudioplayer_options) this.options = $.extend(this.options, amazingaudioplayer_options);
...
jQuery(document).ready(function() {
    ...
    for (var i = 0; i < scripts.length; i++) {
        if (scripts[i].src && scripts[i].src.match(/ap\.js/i))
            jsFolder = scripts[i].src.substr(0, scripts[i].src.lastIndexOf("/") + 1);
    }

    jQuery("#ap-0, #ap-1, #ap-2, #ap-3").amazingaudioplayer({
        jsfolder: jsFolder,
        skinsfoldername: "",
        timeformatlive: "%CURRENT% / LIVE",
        volumeimagewidth: 24,
        ...
        loadingformat: "Loading...",
        prevnextimage: "https://www.cratemayne.com/audioplayerengine2/prevnext-48-48-1.png",
        showinfo: true,
        tracklistitem: 100,
        skin: "LightBox",
        loopimage: "https://www.cratemayne.com/audioplayerengine2/loop-24-24-2.png",
        loopimagewidth: 24,
        showstop: false,
        ...
        showtracklist: true,
        volumeimage: "https://www.cratemayne.com/audioplayerengine2/volume-24-24-2.png",
        playpauseimagewidth: 48,
        tracklistitemformat: "%ARTIST% - %TITLE% <span style='position:absolute;top:0;right:0;'><a href='%AUDIOURL%' target='_self'><i class=\'icon-download\'></i></a></span>",
        showloop: true,
        titleinbarwidthmode: "fixed",
        ...
        fullwidth: true,
        showimage: false,
        timeformat: "%CURRENT% &nbsp/&nbsp %DURATION%",
        showvolume: true,
        showvolumebar: true,
        loop: 0,
        playpauseimage: "https://www.cratemayne.com/audioplayerengine2/playpause-48-48-1.png"
    });
});
...
jQuery(document).ready(function() {
    ...
    jQuery("#ap-mix").amazingaudioplayer({
        jsfolder: jsFolder,
        skinsfoldername: "",
        timeformatlive: "%CURRENT% / LIVE",
        volumeimagewidth: 24,
        ...
        volumeimage: "https://www.cratemayne.com/audioplayerengine2/volume-24-24-2.png",
        playpauseimagewidth: 48,
        tracklistitemformat: "<span class='\ap-track-item-number\'>%INFO%</span> %ARTIST% - %TITLE% <span class='\ap-track-item-duration\'>%DURATION%</span>",
        showloop: true,
        titleinbarwidthmode: "fixed",
        playpauseimageheight: 48,
        loopimageheight: 24,
